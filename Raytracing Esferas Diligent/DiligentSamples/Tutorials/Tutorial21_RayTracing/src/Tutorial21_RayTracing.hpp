...
private:
    ...
    static constexpr int m_NumSpheres          = 50;

    bool                 m_ResourcesNeedUpdate = true;

    void RecreateDynamicResources();

    struct SphereMaterialData
    {
        float4 BaseColor;                 float  Roughness;                 float  Metallic;                  float  IndexOfRefraction;         float  Radius;                };
