...
private:
    ...
    static constexpr int m_NumCubes = 15;
    static constexpr int m_NumSpheres = 15;
    ...
    std::vector<CubeMaterialData>   m_CubeMaterials;
    RefCntAutoPtr<IBuffer>          m_CubeMaterialsBuffer;
    RefCntAutoPtr<IBufferView>      m_CubeMaterialsBufferSRV;


    std::vector<SphereMaterialData> m_SphereMaterials;
    RefCntAutoPtr<IBuffer>          m_SphereMaterialsBuffer;
    RefCntAutoPtr<IBufferView>      m_SphereMaterialsBufferSRV;
    ...
    bool            m_EnableSpheres[m_NumSpheres];
    bool            m_EnableCubes[m_NumCubes];
    bool            m_Animate          = true;
