...
void Tutorial04_Instancing::CreateInstanceBuffer()
{
    ...
    // Cambiar el tamaño para que sea sizeof(InstanceData) * NumInstances
...
void Tutorial04_Instancing::LoadTextures() {
    {
        ...
        // Usamos el descriptor de la primera textura como referencia
        ...
        // Preparar datos para cada slice y cada mip level
    ...
    // ========================================================
    // 2. Texture Array para la textura "grassy" (usada en g_BTexture)
    // ========================================================
    {
        std::vector<RefCntAutoPtr<ITextureLoader>> loaders(NumInstances);
        for (int i = 0; i < NumInstances; ++i)
    ...
    // ========================================================
    // 3. Texture Array para la textura "mud" (usada en g_GTexture)
    // ========================================================
    {
        std::vector<RefCntAutoPtr<ITextureLoader>> loaders(NumInstances);
        for (int i = 0; i < NumInstances; ++i)
    ...
    // ========================================================
    // 4. Texture Array para la textura "path" (usada en g_BackgroundTexture)
    // ========================================================
    {
        std::vector<RefCntAutoPtr<ITextureLoader>> loaders(NumInstances);
        for (int i = 0; i < NumInstances; ++i)
    ...
    // ========================================================
    // 5. Texture Array para la textura "blendMap" (usada en g_BlendMap)
    // ========================================================
        {
            std::vector<RefCntAutoPtr<ITextureLoader>> loaders(NumInstances);
            for (int i = 0; i < NumInstances; ++i)
...
void  Tutorial04_Instancing::PopulateInstanceBuffer()
{
    ...
    InstanceData[2].Matrix = float4x4::Scale(2, 1, 1) * float4x4::Translation(0.0f, 0.0f, 0.0f);                                                          // A
